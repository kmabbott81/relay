...
class TestReranking:
    ...
    async def test_rerank_single_candidate(self):
        ...
        from src.memory.rerank import RerankedResult, rerank
...
class TestFeatureFlag:
    ...
    async def test_maybe_rerank_enabled(self):
        ...
        from src.memory.rerank import maybe_rerank
...
class TestMetrics:
    ...
    def test_get_rerank_metrics(self):
        ...
        from src.memory.rerank import get_rerank_metrics
...
class TestRerankedResult:
    ...
    def test_reranked_result_creation(self):
        ...
        from src.memory.rerank import RerankedResult
